...
istrunc = true; % creates Boolean defaulting istrunc to true
% prompts user to specify if this data is the High or Low concentration
prompt = "Is any of the data truncated? (i.e., Do any of these tracks end early?) \n Answer 'true' or 'false': ";
istrunc = input(prompt); % stores user's answer: true = 1, false = 0
...
% Flag - if color or black
isRed = true; % creates Boolean defaulting isRed to true
% prompts user to specify if this data is the High or Low concentration
prompt = "Plot in color (red)? \n Answer 'true' for color, 'false' for grayscale: ";
isRed = input(prompt); % stores user's answer: true = 1, false = 0
...
if isRed
    ...
    % fill ribbon between conf bounds in red
    ribbon = fill(xconf, yconf, 'r'); % r = red
